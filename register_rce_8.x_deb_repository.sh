...
#echo "deb https://software.dlr.de/updates/rce/8.x/products/standard/snapshots/trunk/deb/ /" >/etc/apt/sources.list.d/dlr_rce_8_snapshots.list
...
echo for RCE 8.x have been successfully installed in your system. You can use 
