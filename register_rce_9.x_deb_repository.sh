...
rm -f /etc/apt/sources.list.d/dlr_rce_8_releases.list
rm -f /etc/apt/sources.list.d/dlr_rce_8_snapshots.list
rm -f /etc/apt/sources.list.d/dlr_rce_9_releases.list
rm -f /etc/apt/sources.list.d/dlr_rce_9_snapshots.list
# TODO query for this choice
#echo "deb https://software.dlr.de/updates/rce/9.x/products/standard/snapshots/trunk/deb/ /" >/etc/apt/sources.list.d/dlr_rce_9_snapshots.list
...
echo for RCE 9.x have been successfully installed in your system. You can use 
